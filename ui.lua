...
function auction:CreateUI()
    ...
    lockCheckbox:SetPoint("TOP", button, "BOTTOM", -34, -12)
    ...
    offspecCheckbox:SetPoint("LEFT", lockCheckbox, "RIGHT", 68, 0)
    ...
    requestButton:SetPoint("TOP", lockCheckbox, "BOTTOM", 34, -12)
