...
auction.changelog = {
    ...
    ["3.1.2"] = {
        "Исправлено отображение окна \"Что нового?\" после обновления аддона",
    },
    ["3.1.3"] = {
...
auction.bosses = {
    ...
    ["Гуртогг Кипящая Кровь"] = {104265, 156234, 156235, 156236, 156237, 156238, 156239, 156240, 156242, 156243, 156244, 156256},
