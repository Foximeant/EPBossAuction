...
auction.bosses = {
    ...
    ["Матушка Шахраз"] = {102229, 156267, 156258, 156259, 156260, 156262, 156264, 156265, 156266, 156276, 156284, 31101, 31102, 31103, 15947, 16948, 16949},
    ["Совет Иллидари"] = {102222, 102226, 102227, 156261, 156263, 156274, 156275, 156277, 156278, 156280, 156281, 156282, 31098, 31099, 31100, 16950, 16951, 16952},
    ["Иллидан Ярость Бури"] = {102228, 156268, 156269, 156285, 156286, 156287, 156288, 156289, 156290, 156291, 156292, 156293, 156294, 156295, 156296, 156297, 31089, 31090, 31091, 16953, 16954, 16955},
}
...
auction.itemNames = {
    ["Лютый Хлад"] = {
        [15908] = "ХОЧУ БИТЬ",
        [15909] = "ХОЧУ ОТДОХНУТЬ",
        [15910] = "ХОЧУ ВАЛИК",
    },
    ["Анетерон"] = {
        [15911] = "ХОЧУ БИТЬ",
        [15912] = "ХОЧУ ОТДОХНУТЬ",
        [15913] = "ХОЧУ ВАЛИК",
    },
    ["Каз'рогал"] = {
        [15914] = "ХОЧУ БИТЬ",
        [15915] = "ХОЧУ ОТДОХНУТЬ",
        [15916] = "ХОЧУ ВАЛИК",
    },
    ["Азгалор"] = {
        [15917] = "ХОЧУ БИТЬ",
        [15918] = "ХОЧУ ОТДОХНУТЬ",
        [15919] = "ХОЧУ ВАЛИК",
    },
    ["Архимонд"] = {
        [15920] = "ХОЧУ БИТЬ",
        [15921] = "ХОЧУ ОТДОХНУТЬ",
        [15922] = "ХОЧУ ВАЛИК",
    },
    ["Мурозонд"] = {
        [15923] = "ХОЧУ БИТЬ",
        [15924] = "ХОЧУ ОТДОХНУТЬ",
        [15925] = "ХОЧУ ВАЛИК",
    },
    ["Верховный полководец Надж'ентус"] = {
        [15926] = "ХОЧУ БИТЬ",
        [15927] = "ХОЧУ ОТДОХНУТЬ",
        [15928] = "ХОЧУ ВАЛИК",
    },
    ["Супремус"] = {
        [15929] = "ХОЧУ БИТЬ",
        [15930] = "ХОЧУ ОТДОХНУТЬ",
        [15931] = "ХОЧУ ВАЛИК",
    },
    ["Реликварий душ"] = {
        [15932] = "ХОЧУ БИТЬ",
        [15933] = "ХОЧУ ОТДОХНУТЬ",
        [15934] = "ХОЧУ ВАЛИК",
    },
    ["Гуртогг Кипящая Кровь"] = {
        [15935] = "ХОЧУ БИТЬ",
        [15936] = "ХОЧУ ОТДОХНУТЬ",
        [15937] = "ХОЧУ ВАЛИК",
    },
    ["Терон Кровожад"] = {
        [15938] = "ХОЧУ БИТЬ",
        [15939] = "ХОЧУ ОТДОХНУТЬ",
        [15940] = "ХОЧУ ВАЛИК",
    },
    ["Тень Акамы"] = {
        [15941] = "ХОЧУ БИТЬ",
        [15942] = "ХОЧУ ОТДОХНУТЬ",
        [15943] = "ХОЧУ ВАЛИК",
    },
    ["Зорт"] = {
        [15944] = "ХОЧУ БИТЬ",
        [15945] = "ХОЧУ ОТДОХНУТЬ",
        [15946] = "ХОЧУ ВАЛИК",
    },
    ["Матушка Шахраз"] = {
        [15947] = "ХОЧУ БИТЬ",
        [16948] = "ХОЧУ ОТДОХНУТЬ",
        [16949] = "ХОЧУ ВАЛИК",
    },
    ["Совет Иллидари"] = {
        [16950] = "ХОЧУ БИТЬ",
        [16951] = "ХОЧУ ОТДОХНУТЬ",
        [16952] = "ХОЧУ ВАЛИК",
    },
    ["Иллидан Ярость Бури"] = {
        [16953] = "ХОЧУ БИТЬ",
        [16954] = "ХОЧУ ОТДОХНУТЬ",
        [16955] = "ХОЧУ ВАЛИК",
    },
}
auction.bossOrder = {
