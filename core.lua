...
auction.itemNames = {
    ["Лютый Хлад"] = {
        [900001] = "Хочу побить,
        [900002] = "Хочу отдохнуть",
        [900003] = "Хочу валик",
    },
    ["Анетерон"] = {
        [900004] = "Хочу побить",
        [900005] = "Хочу отдохнуть",
        [900006] = "Хочу валик",
    },
    ["Каз'рогал"] = {
        [900007] = "Хочу побить",
        [900008] = "Хочу отдохнуть",
        [900009] = "Хочу валик",
    },
    ["Азгалор"] = {
        [900010] = "Хочу побить",
        [900011] = "Хочу отдохнуть",
        [900012] = "Хочу валик",
    },
    ["Архимонд"] = {
        [900013] = "Хочу побить",
        [900014] = "Хочу отдохнуть",
        [900015] = "Хочу валик",
    },
    ["Мурозонд"] = {
        [900016] = "Хочу побить",
        [900017] = "Хочу отдохнуть",
        [900018] = "Хочу валик",
    },
    ["Верховный полководец Надж'ентус"] = {
        [900019] = "Хочу побить",
        [900020] = "Хочу отдохнуть",
        [900021] = "Хочу валик",
    },
    ["Супремус"] = {
        [900022] = "Хочу побить",
        [900023] = "Хочу отдохнуть",
        [900024] = "Хочу валик,
    },
    ["Реликварий душ"] = {
        [900025] = "Хочу побить",
        [900026] = "Хочу отдохнуть",
        [900027] = "Хочу валик",
    },
    ["Гуртогг Кипящая Кровь"] = {
        [900028] = "Хочу побить",
        [900029] = "Хочу отдохнуть",
        [900030] = "Хочу валик",
    },
    ["Терон Кровожад"] = {
        [900031] = "Хочу побить",
        [900032] = "Хочу отдохнуть",
        [900033] = "Хочу валик",
    },
    ["Тень Акамы"] = {
        [900034] = "Хочу побить",
        [900035] = "Хочу отдохнуть",
        [900036] = "Хочу валик",
    },
    ["Зорт"] = {
        [900037] = "Хочу побить",
        [900038] = "Хочу отдохнуть",
        [900039] = "Хочу валик",
    },
    ["Матушка Шахраз"] = {
        [900040] = "Хочу побить",
        [900041] = "Хочу отдохнуть",
        [900042] = "Хочу валик",
    },
    ["Совет Иллидари"] = {
        [900043] = "Хочу побить",
        [900044] = "Хочу отдохнуть",
        [900045] = "Хочу валик",
    },
    ["Иллидан Ярость Бури"] = {
        [900046] = "Хочу побить",
        [900047] = "НХочу отдохнуть",
        [900048] = "Хочу валикХерня 3",
    },
}
auction.bossOrder = {
  --  "TEST",
