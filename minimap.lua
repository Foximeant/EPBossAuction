...
-- ============================================================
-- Открывает/закрывает главное окно (auction.frame) по клику,
-- перетаскивается вокруг миникарты, позиция (угол в градусах)
-- сохраняется в auction.db.minimap.position.
-- ============================================================
